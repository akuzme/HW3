...
import com.transfer.Student.Student;
...
public class StudentTest {
    ...
    public void testGetAvgRating() {
        ...
        assertEquals(Student.getAverageRating(), 22.5d, "Average rating is wrong");
    }
    ...
    public void testChangeRating() {
        ...
        assertEquals(Student.getAverageRating(), 33.0d, "Average rating is wrong");
    }
